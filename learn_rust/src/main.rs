...
fn main() {
    ...
    let int_in: i64 = input.trim().parse().unwrap();// trim function removes the special char at the end of each string which is bacically invisible when we press enter and go to thte newline.
